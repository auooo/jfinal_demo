...
import demo.common.config.DemoConfig;

import javax.sql.DataSource;

/**
 * Created by Hong on 1/6/2016.
 * 在数据表有任何变动时，运行一下 main 方法，极速响应变化进行代码重构
 */
public class _JFinalDemoGenerator {
    ...
    public static void main(String[] args) {
        ...
        Generator generator = new Generator(
                getDataSource(), baseModelPackageName, baseModelOutputDir, modelPackageName, modelOutputDir);
        // 添加不需要生成的表名
        ...
        // 例如表名 "osc_user"，移除前缀"osc_"后生成的 model 名为 "User" 而非 "OscUser"
